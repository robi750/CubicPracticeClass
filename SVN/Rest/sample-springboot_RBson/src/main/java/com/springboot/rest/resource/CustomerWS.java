...
public class CustomerWS {
	...
	public Response create(final CustomerData customer) {
		Logger.debug("Entering CustomerWS.create");
		Logger.info("CustomerData Request Object={}", customer);
		...
		Logger.debug("Existing CustomerWS.create");
	...
	public Response modify(final CustomerData customer) {
		...
		final CustomerData entity = cs.findCustomer(customer.getId());
	...
	public Response Authenticate(@HeaderParam("auth-key") final String authKey,
		...
		obj.put("authukey", authKey);
		obj.put("appiversion", appVersion);
